...
layer_i=2 # the number of unrolling layers in the unrolling network
gsm_i=0 # no graph smoothness term in the loss function: 0 || with this term in the loss function: 1
black_box_i=2 # choose the type of black boxes: GCN:1 || CNN:2 || MLP:3
...
for ee in dataset_i_vec: # loop for all 17 datasets
    ...
    f_textfile= open("results/CNN_MSE_two_layers_dataset_%s.txt" % ee_further,"w+")
