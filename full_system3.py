...
def full_system3(M_normalizer,read_data_train_net,\
                b_ind,\
                db,\
    ...
    return y_1,z_1,\
           y_2,z_2,\
           y_3,z_3,\
           lobpcg_fv_3,M_d_1,M_d_1_,M_d_1__,cL1,cL2,cL3,read_data3,alpha3,LLE_C_matrix1,LLE_C_matrix2,LLE_C_matrix3